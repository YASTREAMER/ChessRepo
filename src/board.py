                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN:
                        ...
                        if event.key == pygame.K_2:
                            ...
                            self.squares[final.row][final.col].piece = Rook(
                                piece.colour
                            )
                            self.prom = False
                            break
                        ...
                        if event.key == pygame.K_3:
                            ...
                            self.squares[final.row][final.col].piece = Knight(
                                piece.colour
                            )
                            prom = False
                            break
                        ...
                        if event.key == pygame.K_4:
                            ...
                            self.squares[final.row][final.col].piece = Bishop(
                                piece.colour
                            )
                            prom = False
                            break
